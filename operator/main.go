...
import (
	...
	"github.com/akakakakakaa/python-package-operator/controllers"
...
func init() {
	...
	utilruntime.Must(pythonpackagev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "51bcc375.github.io",
	})
	if err != nil {
	...
	if err = (&controllers.GlobalPythonPackageCollectionReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("GlobalPythonPackageCollection"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "GlobalPythonPackageCollection")
		os.Exit(1)
	}
